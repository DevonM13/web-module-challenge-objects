...
function getReviewByIndex(result, num) {
  return `${result[num].name} gave the restaurant a ${result[num].rating} star review, and their feedback was: ${result[num].feedback}`; 
}
...
function getLastReview(result) {
  return `${result[result.length -1].name} gave the restaurant a ${result[result.length -1].rating} star review, and their feedback was: ${result[result.length -1].feedback}`
} 
